    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu_name_en', models.SlugField(blank=True, max_length=150, null=True)),
                ('menu_name_ru', models.SlugField(blank=True, max_length=150, null=True)),
                ('menu_name_uz', models.SlugField(blank=True, max_length=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_en', models.CharField(max_length=100, null=True, unique=True, verbose_name='Menu:')),
                ('name_ru', models.CharField(max_length=100, null=True, unique=True, verbose_name='Menu:')),
                ('name_uz', models.CharField(max_length=100, null=True, unique=True, verbose_name='Menu:')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('news_body', ckeditor.fields.RichTextField(verbose_name='Text')),
                ('news_body_en', ckeditor.fields.RichTextField(null=True, verbose_name='Text')),
                ('news_body_ru', ckeditor.fields.RichTextField(null=True, verbose_name='Text')),
                ('news_body_uz', ckeditor.fields.RichTextField(null=True, verbose_name='Text')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=150)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tourism', to='culture_tourism.Regions')),
            ],
            options={
                'ordering': ('-created',),
            },
